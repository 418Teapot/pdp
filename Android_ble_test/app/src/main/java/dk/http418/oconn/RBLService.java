...
import dk.http418.oconn.RBLGattAttributes;
...
public class RBLService extends Service {
	...
	public final static UUID UUID_BLE_SHIELD_TX = UUID
			.fromString(dk.http418.oconn.RBLGattAttributes.BLE_SHIELD_TX);
	public final static UUID UUID_BLE_SHIELD_RX = UUID
			.fromString(dk.http418.oconn.RBLGattAttributes.BLE_SHIELD_RX);
	public final static UUID UUID_BLE_SHIELD_SERVICE = UUID
			.fromString(dk.http418.oconn.RBLGattAttributes.BLE_SHIELD_SERVICE);
	...
	public class LocalBinder extends Binder {
		dk.http418.oconn.RBLService getService() {
			return dk.http418.oconn.RBLService.this;
		}
	}
