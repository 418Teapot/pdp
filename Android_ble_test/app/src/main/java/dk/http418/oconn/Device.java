...
import dk.http418.oconn.SelectVeggie;
...
public class Device extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setTitle(device_names);
		setTitle("Vælg en vægt");
		...
		// hvis vi ikke finder noget device - lav et fake demo device!
		if(listItems.size() <= 0){
			map = new HashMap<String, String>();
			map.put(DEVICE_NAME, "DemoDevice");
			map.put(DEVICE_ADDRESS, "http 1.1 418");
			listItems.add(map);
		}
	...
	public void onItemClick(AdapterView<?> adapterView, View view,
		...
		Intent intent = new Intent(Device.this, dk.http418.oconn.SelectVeggie.class);
